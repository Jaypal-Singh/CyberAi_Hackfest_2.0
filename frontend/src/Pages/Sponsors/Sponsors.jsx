...
const SPONSORS_DATA = [
  { id: 1, name: "isg", logo: isg, url: "https://isgindia.org/" },
  ...
  return (
    ...
    >
      ...
      >
        ...
        ></div>
        <div className="relative z-10 bg-white p-4 rounded-xl w-full flex items-center justify-center h-32 overflow-hidden">
          <img
            src={sponsor.logo}
            alt={sponsor.name}
...
// // --- SPONSORS DATA (Filtered Section) ---
// const SPONSORS_TIERED_DATA = [
//   { id: 101, name: "Cyber Intel", logo: spodummy, url: "#", tier: "PLATINUM" },
//   {
//     id: 102,
//     name: "Nexus Systems",
//     logo: spodummy,
...
//     tier: "PLATINUM",
//   },
//   { id: 103, name: "Gold Standard", logo: spodummy, url: "#", tier: "GOLD" },
//   { id: 104, name: "Aura Tech", logo: spodummy, url: "#", tier: "GOLD" },
//   { id: 105, name: "Silver Line", logo: spodummy, url: "#", tier: "SILVER" },
//   { id: 106, name: "Iron Logic", logo: spodummy, url: "#", tier: "SILVER" },
// ];
...
//         className="relative w-full aspect-[16/10] bg-[#0d0d15] border border-purple-500/10 rounded-xl flex items-center justify-center p-8 transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)]
//                       group-hover:border-fuchsia-500/40 group-hover:shadow-[0_25px_60px_rgba(217,70,239,0.2)]
//                       transform-gpu group-hover:[transform:rotateX(30deg)_translateY(10px)]"
//       >
//         <div
//           className="absolute inset-0 opacity-5 group-hover:opacity-10 transition-opacity"
//           style={{
...
//     if (activeTier === "ALL") return SPONSORS_TIERED_DATA;
//     return SPONSORS_TIERED_DATA.filter((s) => s.tier === activeTier);
//   }, [activeTier]);
...
//       {/* --- Sponsor Filter Navbar --- */}
//       <div className="relative z-20 mb-20">
//         <div className="flex bg-[#0d0d15]/80 backdrop-blur-md border border-purple-500/20 p-1.5 rounded-2xl">
//           {tiers.map((tier) => (
//             <button
//               key={tier}
//               onClick={() => setActiveTier(tier)}
//               className={`px-6 py-2 rounded-xl text-xs font-bold tracking-[0.2em] transition-all duration-300
//                 ${
//                   activeTier === tier
...
//       {/* --- Filtered Sponsors Grid --- */}
//       <div className="relative z-10 w-full max-w-7xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-24 mb-40">
//         {filteredSponsors.map((sponsor) => (
//           <div key={sponsor.id} className="flex flex-col items-center gap-8">
//             <h3 className="text-xl font-bold tracking-[0.4em] text-purple-400 font-[oswald] uppercase">
//               {sponsor.tier}
//             </h3>
//             <SponsorCard sponsor={sponsor} />
//           </div>
...
//       {/* --- Section 2: Partners Header (Static) --- */}
//       <div className="relative z-10 mb-32 text-center">
//         <h2 className="text-4xl md:text-7xl font-bold tracking-[0.3em] text-white uppercase font-[oswald]">
//           OUR <span className="text-purple-600">PARTNERS</span>
//         </h2>
