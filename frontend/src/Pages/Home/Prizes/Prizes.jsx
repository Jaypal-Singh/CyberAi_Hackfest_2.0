...
const Prizes = () => {
    return (
        <section className="prizes-container">
            ...
            <SpotlightCard className="w-full max-w-5xl mx-auto custom-spotlight-card" spotlightColor="rgba(255, 255, 255, 0.1)">
                <div className="p-10 flex flex-col items-center">
                    ...
                    <div className="consolation-section">
                        ...
                        <p className="consolation-amount">₹5,000 each for 10 Teams</p>
                    </div>
