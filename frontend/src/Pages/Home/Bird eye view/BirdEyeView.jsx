...
import Campus_img_1 from "../../../assets/Campus_Tour/Campus_img5.png";
import Campus_img_2 from "../../../assets/Campus_Tour/Campus_img6.png";
import Campus_img_3 from "../../../assets/Campus_Tour/Campus_img7.png";
import Campus_img_4 from "../../../assets/Campus_Tour/Campus_img8.png";
    ...
    <div className="relative w-full h-[80vh] md:h-screen bg-black overflow-hidden flex flex-col justify-end">
      <div className="absolute inset-0 z-0 flex items-center justify-center">
        <video
          ...
          loop
          muted
          className="w-[95%] md:w-[90%] h-[80%] md:h-[90%] object-cover rounded-2xl md:rounded-3xl shadow-2xl"
        >
      ...
      <div className="absolute top-20 right-4 md:top-10 md:right-18 z-20">
        <a
          href="https://spu.ac.in/VirtualTour/index.htm"
          target="_blank"
        ...
        >
          <button className="cursor-pointer bg-white/10 backdrop-blur-md border border-white/20 text-white px-5 py-2 md:px-6 md:py-2.5 rounded-full flex items-center gap-2 hover:bg-white/20 hover:scale-105 transition-all font-medium text-xs md:text-sm uppercase tracking-wide shadow-lg group">
            Bird Eye View
            <span className="bg-white text-black rounded-full w-5 h-5 flex items-center justify-center text-[10px] group-hover:rotate-45 transition-transform duration-300">
              ↗
            </span>
          </button>
        </a>
      ...
      <div className="relative z-20 w-full max-w-[1400px] mx-auto px-4 pb-2 md:pb-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5">
          {[
            ...
            <div
              key={item.id}
              className="group relative aspect-video rounded-xl md:rounded-2xl overflow-hidden cursor-pointer border border-white/10 hover:border-purple-500/50 transition-all shadow-2xl bg-gray-900"
            >
              {/* Image Content */}
              <div
              ...
              <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/90 to-transparent">
                <p className="text-white text-xs md:text-sm font-medium translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                  {item.title}
                </p>
              </div>
            </div>
