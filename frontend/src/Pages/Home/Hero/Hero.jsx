    ...
    >
      ...
      <div
        style={{
          ...
          transition:
            "transform 0.2s cubic-bezier(0.25, 0.46, 0.45, 0.94), filter 0.2s linear, opacity 0.2s linear",
        }}
      >
        <h1 className="text-5xl md:text-[7rem] font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-b from-white to-purple-200 drop-shadow-[0_0_25px_rgba(168,85,247,0.6)] tracking-tighter leading-tight font-[sans-serif]">
          Cyber<span className="text-purple-600">AI</span>{" "}
          <br className="md:hidden" /> Hackfest 2.0
        </h1>
        <p className="text-lg md:text-3xl text-gray-300 tracking-[0.2em] font-light uppercase mt-2 mb-8">
