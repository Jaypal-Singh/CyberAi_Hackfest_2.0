    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          strokeLinejoin="round"
        >
          <path d="M17.5 19c0-1.7-1.3-3-3-3h-1.1c-.2-1.8-1.7-3.2-3.5-3.2-1.6 0-3 1.1-3.4 2.6H6c-2.2 0-4 1.8-4 4s1.8 4 4 4h11.5c1.9 0 3.5-1.6 3.5-3.5z" />
        </svg>
      ),
    },
    {
...

    {
      ...
      icon: (
        <svg
          ...
          strokeLinejoin="round"
        >
          <path d="M10 21c-2 0-3-1-3-4a16 16 0 0 1 6-6 16 16 0 0 1 6 6c0 3-1 4-3 4" />
          <path d="M10.5 7A14 14 0 0 0 8 13.5" />
          <path d="M13.5 7A14 14 0 0 1 16 13.5" />
          <path d="M7 16a3 3 0 1 1-6 0c0-1.5.5-2 1.5-2.5" />
          <path d="M23 16a3 3 0 1 0-6 0c0-1.5-.5-2-1.5-2.5" />
          <path d="M16 4a4 4 0 1 1-8 0" />
        </svg>
      ),
    },
  ];
