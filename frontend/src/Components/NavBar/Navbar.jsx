...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 bg-black/95 backdrop-blur-xl z-[60] flex flex-col items-center justify-center transition-transform duration-500 ${
      ...
      >
        ...
        <ul className="flex flex-col gap-8 text-center list-none p-0 m-0">
          ...
          <li className="mt-4">
            <button className="bg-gradient-to-r from-purple-500 to-purple-500 text-white font-bold py-3 px-10 rounded-full shadow-lg shadow-purple-500/30 text-xl transform hover:scale-105 transition-transform">
              Register Now
            </button>
          </li>
        </ul>
